            ...
            <div :id="mode + '-menu-navbar'" :class="'navbar' + (mode == 'header' ? ' collapse navbar-collapse' : '')">
                <ul class="navbar-nav">
                    <li class="nav-item" v-if="!logged_in">
                        <a class="nav-link link-signup" :href="app_url + '/signup'">Signup</a>
                    </li>
                    <li class="nav-item" v-if="!logged_in">
                    ...
                    <li class="nav-item" v-if="logged_in">
                        <a class="nav-link menulogin link-logout" active-class="active" :href="app_url + '/logout'">Logout</a>
                    </li>
                    <li class="nav-item" v-if="!logged_in">
                        <a class="nav-link menulogin link-login" active-class="active" :href="app_url">Login</a>
                    </li>
                </ul>
